  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onloadend = () => {
        ...
        toast.success('Foto de Profile atualizada');
      };

      reader.onerror = () => {
        console.error('Error reading file:', reader.error);
        setIsUploading(false);
        toast.error('Falha na atualização da Foto de Profile');
      };
      reader.readAsDataURL(file);
    } catch (error) {
      console.error('Error uploading avatar:', error);
      setIsUploading(false);
      toast.error('Falha ao carregar a Foto de Profile');
    }
  };
        ...
        <div>
          ...
          <div className="flex items-start gap-6 mb-8">
            ...
            <div className="flex-1 pt-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Upload a Foto de Profile or avatar</p>
            </div>
          </div>
