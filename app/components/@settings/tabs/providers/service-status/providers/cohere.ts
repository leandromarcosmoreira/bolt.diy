  ...
  async checkStatus(): Promise<StatusCheckResult> {
    try {
      ...
      const services = {
        ...
        generation: {
          operacional: text.includes('Generation Service') && text.includes('Operacional'),
          instavel: text.includes('Generation Service') && text.includes('Desempenho degradado'),
          outage: text.includes('Generation Service') && text.includes('Desempenho degradado'),
        },
      };
      ...
      } else if (services.api.instavel || services.generation.instavel || hasDegradation || hasIncidents) {
        status = 'instavel';
        message = 'Desempenho degradado';
